  ...
  datasets: [
    {
       fill:true,     
      label: 'last 30 days',
      data:[2.5,2.6,3,2.9,2.95,2.8,2.85,2.6,2.5,2.8,3.1,3,2.9,3,2.9,3.4,3.6,3.9,4.2,4.4,4.3,4.3,4.1,3.9,3.5,3.2,2.9,3.12,2.9,2.7,2.8,2.6,2.4],
      borderColor: 'rgb(125, 187, 5)',
